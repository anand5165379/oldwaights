...
data_path = '/home/vishnnu/Documents/data/paddy_tl/data/test'
target_path = '/home/vishnnu/Documents/data/paddy_tl/data/test_extractions'
	...
	for image_path in tqdm.tqdm(all_files, total=len(all_files), desc=folder_name):
		...
		for idx, extracted_image in enumerate(segment_image(image)):
			if extracted_image is None:
				...
				save_name = str(target_folder / f'{name}_{idx}.jpg')
