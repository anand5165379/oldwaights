...
class AutoExtractionSMC:
    ...
    def __init__(self):
        ...
        self.segmentor_input_dir = os.path.join(self.file_directory, 'r')
        self.segmentor_output_dir = os.path.join(self.file_directory, 'e')
        self.smc_input_dir = self.segmentor_output_dir
        self.smc_output_dir = os.path.join(self.file_directory, 's')
